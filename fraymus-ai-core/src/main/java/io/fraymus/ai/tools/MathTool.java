...
/**
 * MATH TOOL - Deterministic Math Evaluation
 * 
 * Supports: + - * / ^
...
public class MathTool {
    ...
    public ToolResult execute(Map<String, Object> args) {
        ...
        try {
            ...
            return new ToolResult("calc", String.valueOf(result));
        } catch (Exception e) {
            return new ToolResult("calc", "[MATH ERROR] " + e.getMessage());
        }
    }
    ...
    private boolean rightAssoc(String op) { return op.equals("^"); }
