...
/**
 * RAG ENGINE: Builds context window with citations.
 * 
 * This is the piece that makes local Ollama punch above hosted models:
 * it injects only the best chunks, safely labeled as untrusted.
 */
