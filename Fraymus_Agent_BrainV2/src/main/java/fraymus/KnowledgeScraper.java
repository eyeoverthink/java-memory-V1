    ...
    private void processFile(Path path) throws Exception {
        ...
        if (nameLower.endsWith(".pdf")) {
            ...
            try {
                ...
                // Limit page extraction for very large PDFs
                if (pageCount > 1000) {
                    CommandTerminal.printColored(String.format("  Large PDF (%d pages) - extracting first 1000 pages only", pageCount), 1.0f, 0.7f, 0.0f);
