...
public class ExperimentManager {
    ...
    private final PhiWorld world;
    private FQFDeploymentFramework fqfFramework;
    private SessionConsciousnessBridge sessionBridge;
    private TriMe triMe;
    private AutonomousCognitiveLoop cognitiveLoop;
    private final InfiniteMemory infiniteMemory;
    private final PassiveLearner passiveLearner;
    private final PhiNeuralNet neuralNet;
    private final QRGenome qrGenome;
    ...
    private String currentModel = "eyeoverthink/Fraymus:latest";  // Use confirmed available model
    ...
    public ExperimentManager(PhiWorld world, InfiniteMemory infiniteMemory,
        ...
        this.cognitiveLoop = new AutonomousCognitiveLoop();
    ...
    public void runOllama(String args) {
        ...
        switch (sub) {
            ...
            case "local":
                ...
                CommandTerminal.print("  Model: " + currentModel);
                CommandTerminal.printInfo("Using FRAYMUS NEXUS v2.0 - Self-evolving Digital Organism");
                break;
